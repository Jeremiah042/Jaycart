...
import { BlogPost } from "@/src/Constant/data";
...
export default function FeaturedPost({ post }: FeaturedPostProps) {
  return (
    ...
    >
      {/* Image side */}
      <div
        className="bg-gradient-to-br from-green-50 to-emerald-100 min-h-[220px] md:min-h-[260px]
      ...
      <div className="p-6 md:p-8 flex flex-col justify-center gap-3">
        ...
        <h2
          className="font-playfair text-2xl font-semibold leading-snug text-gray-800
